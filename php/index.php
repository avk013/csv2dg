...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter39034475 = new Ya.Metrika({
                    id:39034475,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/39034475" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
 </head>';
...
if ($row[0]>0) {echo '&nbsp;<a href="?gr='.$row[0].'">-'.$row[0]."-</a>&nbsp;";}
echo ";)<HR>"; 
//if($_GET["gr"] ||$_GET["prp"])
{
	$gr=(int)$_GET["gr"];
...
echo '<HR><small><small><small><small>ЗЫ: давайте будем делать что-то разумно</small></small></small><b>(C)&nbsp;avk013</b></small></html>';
?>