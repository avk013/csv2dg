...
//$uploadFile='/rozklad+/server/rozklad.csv'
//echo $uploadFile;
//print "<PRE>123";
...
while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) {
	...
	$prp=mysql_real_escape_string($data[4]);
	$prdm=mysql_real_escape_string($data[3]);
	$query = "INSERT INTO 1rozklad(gr,dat,nomer,displn,prpd) VALUES('$gr','$dat','$nomer','$prdm','$prp')";
